    ...
    <aside class="w-60 bg-navy flex flex-col shrink-0">
        ...
        <nav class="flex-1 px-3 space-y-0.5">
            <a href="{{ route('dashboard') }}"
               class="group flex items-center gap-3 px-3 py-2.5 text-sm rounded transition-colors
                ...
                @if(request()->routeIs('dashboard'))
                    <span class="absolute left-0 w-0.5 h-6 bg-brass rounded-r ml-[-0.75rem]" style="margin-left: -0.75rem"></span>
                @endif
